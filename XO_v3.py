...
print("Задача: выстроить в ряд 3 своих фигуры по вертикали, горизонтали или большой диагонали. Если игроки заполнили")
print("все 9 ячеек и оказалось, что ни в одной вертикали, горизонтали или большой диагонали нет трёх одинаковых")
print("знаков, партия считается закончившейся в ничью. Первый ход делает игрок, ставящий крестики.")
print("    Выигрывает сторона непрерывно заполнившая три ячейки (нолика или крестика), составляющих сплошной ряд,")
print("столбец или большую диагональ.\n")
while True:
    map = [["-", "-", "-"],  # Пустое поле
           ["-", "-", "-"],
           ["-", "-", "-"]]
